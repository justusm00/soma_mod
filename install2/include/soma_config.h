...
//! Automatically set by CMake
#define ENABLE_DOMAIN_DECOMPOSITION 0

//! Macro to activate monomer type conversions
//! Automatically set by CMake
#define ENABLE_MONOTYPE_CONVERSIONS 0
...
static const char soma_version[] = "-unknown MPI DOUBLE OpenACC";
//! Returns the version string.
//! \return Pointer to version string
const char *get_soma_version(void);

//! String describing the system info for which SOMA has been compiled.
static const char soma_system_info[] = "Linux-3.10.0-1160.76.1.el7.x86_64 with PGI for x86_64 ";
