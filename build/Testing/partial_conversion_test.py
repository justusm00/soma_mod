...
def main(argv):
    ...
    ret = sp.call(["/opt/homebrew/bin/mpiexec","-n","1",SOMA,"-c","partial_conversion.h5","-t","1000","-f","partial_conversion_end.h5"]+additional_flags)
    ...
    ret = sp.call(["/opt/homebrew/bin/mpiexec","-n","1",SOMA,"-c","partial_conversion_dd.h5","-t","1000","-f","partial_conversion_dd_end.h5"]+additional_flags)
